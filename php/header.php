<?php
	...
	if($_GET['orrialdea'] != "index" && $_GET['orrialdea'] != "erregistratu" && $_GET['orrialdea'] != "pasahitzaberreskuratu" && $_GET['orrialdea'] != "eskaerabidali" && $_GET['orrialdea'] != "pasahitzabidali"){
...
<script src="js/orokorra.js" type="text/javascript"></script>
